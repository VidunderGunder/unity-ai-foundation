...
public class Config : MonoBehaviour
{
    ...
    public string Trainer => (string) defaultSettings.trainer_type.value;
    ...
    public class TrainerSettings : Settings
    {
        ...
        public Entry keep_checkpoints = new Entry(
            "keep_checkpoints", 5,
            active: true,
            help:
        ...
        public Entry checkpoint_interval = new Entry(
        ...
        public Entry init_path = new Entry(
            "init_path", "",
            active: true,
            help:
        ...
        public Entry threaded = new Entry(
            "threaded",
            true,
            active: true,
            help:
        ...
        public class NetworkSettings : Settings
        {
            ...
            public Entry normalize = new Entry(
                "normalize", false,
                active: true,
                help:
            ...
            public Entry vis_encode_type = new Entry(
        ...
        public class Hyperparameters : Settings
        {
            ...
            public Entry batch_size = new Entry(
                "batch_size", 256,
                active: true,
                help:
            ...
            public Entry buffer_size = new Entry(
                "buffer_size", 10240,
                active: true,
                help:
            ...
            public Entry learning_rate_schedule = new Entry(
            ...
            public Entry epsilon = new Entry(
                "epsilon", 0.2f,
                active: true,
                trainers: new List<string> { "ppo", "poca" },
                help:
            ...
            public Entry num_epoch = new Entry(
                "num_epoch", 3,
                active: true,
                trainers: new List<string> { "ppo", "poca" },
                help:
            ...
            public Entry buffer_init_steps = new Entry(
                "buffer_init_steps", 0,
                active: true,
            ...
            public Entry init_entcoef = new Entry(
                "init_entcoef", 1.0f,
                active: true,
                trainers: new List<string> { "sac" },
                help:
            ...
            public Entry save_replay_buffer = new Entry(
            ...
            public Entry steps_per_update = new Entry(
                "steps_per_update", 1,
                active: true,
                trainers: new List<string> { "sac" },
                help:
    ...
    public class EngineSettings : Settings
    {
        ...
        public Entry time_scale = new Entry("time_scale", 1.0f);
        public Entry quality_level = new Entry("quality_level", 5);
        public Entry target_frame_rate = new Entry("target_frame_rate", -1);
        public Entry capture_frame_rate = new Entry("capture_frame_rate", 60);
        public Entry no_graphics = new Entry("no_graphics", false);
        public Entry width = new Entry("width", 84);
        public Entry height = new Entry("height", 84);
    }
    [System.Serializable]
    ...
    public class CheckpointSettings : Settings
    {
        ...
        public Entry run_id = new Entry("run_id", "mlady");
        public Entry initialize_from = new Entry("initialize_from", "");
        public Entry load_model = new Entry("load_model", false);
        public Entry resume = new Entry("resume", false);
        public Entry force = new Entry("force", false);
        public Entry train_model = new Entry("train_model", false);
        public Entry inference = new Entry("inference", false);
        public Entry results_dir = new Entry("results_dir", "Results");
    }
    [System.Serializable]
    ...
    public void WriteFile()
    {
        ...
        void WriteLines()
        {
            ...
            indent++;
            EntryLine(defaultSettings.trainer_type);
            EntryLine(defaultSettings.summary_freq);
            EntryLine(defaultSettings.max_steps);
            EntryLine(defaultSettings.checkpoint_interval);
            EntryLine(defaultSettings.keep_checkpoints);
            EntryLine(defaultSettings.time_horizon);
            EntryLine(defaultSettings.init_path);
            EntryLine(defaultSettings.threaded);

            SettingsLine(defaultSettings.hyperparameters);
            indent++;
            EntryLine(defaultSettings.hyperparameters.batch_size);
            EntryLine(defaultSettings.hyperparameters.buffer_size);
            EntryLine(defaultSettings.hyperparameters.learning_rate);
            EntryLine(defaultSettings.hyperparameters.learning_rate_schedule);

            EntryLine(defaultSettings.hyperparameters.beta);
            EntryLine(defaultSettings.hyperparameters.epsilon);
            EntryLine(defaultSettings.hyperparameters.lambd);
            EntryLine(defaultSettings.hyperparameters.num_epoch);
            ...
            SettingsLine(defaultSettings.network_settings);
            indent++;
            EntryLine(defaultSettings.network_settings.hidden_units);
            EntryLine(defaultSettings.network_settings.num_layers);
            EntryLine(defaultSettings.network_settings.vis_encode_type);
            EntryLine(defaultSettings.network_settings.normalize);
            indent--;
            indent--;

            SettingsLine(checkpointSettings);
            indent++;
            EntryLine(checkpointSettings.results_dir);
            EntryLine(checkpointSettings.run_id);
            EntryLine(checkpointSettings.initialize_from);
            EntryLine(checkpointSettings.resume);
            EntryLine(checkpointSettings.force);
            EntryLine(checkpointSettings.inference);
            EntryLine(checkpointSettings.load_model);
            EntryLine(checkpointSettings.train_model);
            indent--;

            SettingsLine(engineSettings);
            indent++;
            EntryLine(engineSettings.time_scale);
            EntryLine(engineSettings.quality_level);
            EntryLine(engineSettings.target_frame_rate);
            EntryLine(engineSettings.capture_frame_rate);
            EntryLine(engineSettings.width);
            EntryLine(engineSettings.height);
            EntryLine(engineSettings.no_graphics);
            indent--;
